...
open class RNLineChartManager: RCTViewManager, RNBarLineChartBaseManager {
    ...
    func zoomViewEnd(_ reactTag: NSNumber, scaleX: NSNumber, axisDependency: NSString) {
        (self as RNBarLineChartBaseManager)._zoomViewEnd(reactTag, scaleX: scaleX, axisDependency: axisDependency)
    }
